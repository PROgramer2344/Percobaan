...
// AMBIL IMAGE & SOUND DARI CSS
const shipImg=new Image();
shipImg.src=getComputedStyle(document.documentElement)
.getPropertyValue("--ship-img").replace('url("','').replace('")','');

const hitSound=new Audio(
 getComputedStyle(document.documentElement)
 .getPropertyValue("--hit-sound").replace('url("','').replace('")','')
);
